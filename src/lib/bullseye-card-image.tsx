...
import type { BullseyeMatch } from "@/lib/bullseye";
...
/** Render the bull's-eye digest card to a PNG. Shared by the API route. */
export function renderBullseyeCard(matches: BullseyeMatch[]): ImageResponse {
    ...
    (
      ...
      >
        <div style={{ display: "flex", flexDirection: "column", height: TITLE_H }}>
          <div
            style={{ display: "flex", fontSize: 64, fontWeight: 700, color: "#ffffff" }}
          >
            🎯 Bull&apos;s Eye
          </div>
          <div
